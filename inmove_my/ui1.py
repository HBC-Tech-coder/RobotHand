...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        control_layout.setContentsMargins(30, 40, 30, 30)
        ...
        port_label.setStyleSheet("font-size: 12pt; color: #666;")
        ...
        self.demo_btn.setMinimumHeight(50)
        ...
        status_dot = QLabel("●")
        status_dot.setStyleSheet("color: #5B8DEE; font-size: 14pt;")
        status_title = QLabel("状态提示")
        status_title.setStyleSheet("font-size: 12pt; font-weight: bold; color: #333;")
        ...
        help_dot = QLabel("●")
        help_dot.setStyleSheet("color: #5B8DEE; font-size: 14pt;")
        help_title = QLabel("操作提示")
        help_title.setStyleSheet("font-size: 12pt; font-weight: bold; color: #333;")
        help_header.addWidget(help_dot)
        help_header.addWidget(help_title)
        help_header.addStretch()
        help_layout.addLayout(help_header)
        
        help_text = """<p style="font-size:10pt; margin: 3px 0; color: #666;">01.点击"开始程序"启动手势识别</p>
<p style="font-size:10pt; margin: 3px 0; color: #666;">02.检测手指弯曲状态并发送信号</p>
<p style="font-size:10pt; margin: 3px 0; color: #666;">03.启动后按钮变为"结束程序"</p>
<p style="font-size:10pt; margin: 3px 0; color: #666;">04.点击"退出程序"关闭应用</p>"""
        self.help_text = QLabel(help_text)
        self.help_text.setWordWrap(True)
        help_layout.addWidget(self.help_text)
        
        control_layout.addWidget(help_container)
        
        # 音乐可视化显示区域（黑色圆角容器）
        self.music_viz_label = QLabel()
        self.music_viz_label.setFixedSize(380, 240)
        ...
        # 版权信息
        copyright_label = QLabel("2025 海百合手势控制系统")
        copyright_label.setAlignment(Qt.AlignCenter)
        copyright_label.setStyleSheet("font-size: 9pt; color: rgba(255,255,255,0.7); margin-top: 10px;")
